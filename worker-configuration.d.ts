/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cfa47e693a5083aee389e1a1e3c3ad82)
...
declare namespace Cloudflare {
	...
	interface Env {
		AI: Ai;
		OS_UPDATE_USER: string;
		OS_UPDATE_PASS: string;
		EMBEDDING_KEY: string;
		UPDATE_KEY: string;
		PROXY_TOKEN: string;
		PROXY_URL: string;
		REINDEX_WORKFLOW: Workflow<Parameters<import("./src/index").ReIndexWorkflow['run']>[0]['payload']>;
		UPDATE_WORKFLOW: Workflow<Parameters<import("./src/index").UpdateWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OS_UPDATE_USER" | "OS_UPDATE_PASS" | "EMBEDDING_KEY" | "UPDATE_KEY" | "PROXY_TOKEN" | "PROXY_URL">> {}
}
